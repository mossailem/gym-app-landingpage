  ...
  let productFeatures = [
    {
      featureList: [
        ...
        "Wights and reps tracker",
        "Community challenges",
        "Every workout is new and exciting",
      ],
      description:
        "Swoley moley ensures all users have the information they need to train safely train effectively.",
    ...
    },
    {
      featureList: [
        ...
        "Guarantees progrerss on all core excersises",
      ],
      description:
    ...
    },
    {
      ...
      description:
        "Enter as much information about yourselft as you desire to ensure all workouts are personalized to your every need.",
  ...
  >
    ...
    {#each productFeatures as productFeature, index}
      <ProductCard {productFeature} {index}>
        {#if index === 0}Experience a beginner exercise <span
            class="text-indigo-400 font-medium">master</span
          > class{:else if index === 1}Lay the foundations for <span
            class="text-indigo-400 font-medium">routines</span
          > and consistency{:else}
          Workouts specific to your <span class="text-indigo-400 font-medium"
            >environments</span
          >
          and
          <span class="text-indigo-400 font-medium">expertises</span
          >{/if}</ProductCard
      >
    {/each}
  </div>
